...
# 系统内核源码路径
export LINUX_PATH=$CONTEXT_PATH/temp/linux

# 交叉编译工具路径
export TOOLS_PATH=$CONTEXT_PATH/temp/tools

# 升级补丁
export UPGRADE_PATCH=UpgradePatch

# 编译好的升级补丁路径
export UPGRADE_PATCH_PATH=$CONTEXT_PATH/temp/$UPGRADE_PATCH
